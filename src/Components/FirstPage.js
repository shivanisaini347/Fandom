      ...
      <div>
        ...
        <div className="mainn" id="Locationdata">
          ...
          <div className="Location">
            <div className="head">
              <h1  style={{borderBottom: "2px solid #CECBCE", fontFamily:"times new roman" ,fontStyle:"oblique", fontWeight:"bolder", fontSize:"40px"}}>Location - <span>{r.name}</span></h1>
            </div>
